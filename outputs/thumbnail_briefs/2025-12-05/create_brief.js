...
const thumbnailV1 = fs.readFileSync('/Users/marwankashef/Desktop/YouTube/YT Command Centre/outputs/thumbnails/2025-12-05/claude_code_swiss_knife_v1.png');
const thumbnailV2 = fs.readFileSync('/Users/marwankashef/Desktop/YouTube/YT Command Centre/outputs/thumbnails/2025-12-05/claude_code_swiss_knife_v2.png');
const thumbnailV3 = fs.readFileSync('/Users/marwankashef/Desktop/YouTube/YT Command Centre/outputs/thumbnails/2025-12-05/claude_code_swiss_knife_v3.png');
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        ...
        spacing: { after: 400 },
        children: [
          new TextRun({ text: "Date: December 5, 2025 | Version: 1.0", size: 22, color: "999999" })
        ]
      }),
      ...
      new Paragraph({ numbering: { reference: "bullet-list", level: 0 }, children: [new TextRun("Image format conversion (PNG ↔ JPG, WEBP, etc.)")] }),
      new Paragraph({ numbering: { reference: "bullet-list", level: 0 }, children: [new TextRun("PDF merging/splitting")] }),
      new Paragraph({ numbering: { reference: "bullet-list", level: 0 }, children: [new TextRun("Audio extraction from video (MP4 → MP3)")] }),
      ...
      new Paragraph({ numbering: { reference: "bullet-list", level: 0 }, children: [new TextRun({ text: "Processing Stack: ", bold: true }), new TextRun("Mark pointing at a \"stack\" of file types being processed by Claude Code (video → audio, PDF → merged PDF, etc.)")] }),
      ...
      new Paragraph({ spacing: { after: 300 }, children: [new TextRun({ text: "Recommended Gradients: ", bold: true }), new TextRun("Purple→Blue or Orange→Red")] }),
      ...
      new Paragraph({ spacing: { after: 200 }, children: [new TextRun({ text: "Three distinct concepts generated for testing. Each tests a different psychological hook.", italics: true, color: "666666" })] }),
      ...
      new Paragraph({ spacing: { after: 100 }, children: [new TextRun({ text: "Pose: ", bold: true }), new TextRun("speaking_shocked.png | "), new TextRun({ text: "Text: ", bold: true }), new TextRun("SWISS ARMY KNIFE FOR DEVELOPERS")] }),
      new Paragraph({
        alignment: AlignmentType.CENTER,
        spacing: { after: 300 },
        children: [new ImageRun({
